...
export const metadata: Metadata = {
  title: "Supportly - Human-friendly AI",
  description:
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} antialiased bg-[#050509] min-h-screen flex flex-col p-0 text-zinc-100 selection:bg-zinc-800 font-sans`}
      >
