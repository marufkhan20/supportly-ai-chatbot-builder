  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center relative z-20">
        ...
        <p className="text-lg md:text-xl text-zinc-400 font-light md-10 max-w-2xl m-auto leading-relaxed">
          Instantly resolve customer queries with an assistant that reads your
          docs and speaks with empathy. No robotic replies, just answers.{" "}
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 my-20">
          ...
          <button className="h-11 px-8 rounded-full border border-zinc-800 text-zinc-300 hover:border-zinc-600 hover:text-white text-sm font-medium transition-all cursor-pointer">
            View demo
          </button>
        </div>
      </div>
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-zinc-950/30">
                ...
                <div className="flex max-w-[85%] gap-3 flex-row">
                  <div className="size-8 rounded-full flex items-center justify-center shrink-0 border">
                    <Image
                      width={40}
                      height={40}
                      src="https://plus.unsplash.com/premium_photo-1661764549854-679f7b3adb47?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt="Support Agent"
              ...
              <div className="flex w-full flex-col items-end">
                <div className="flex max-w-[85%] gap-3 flex-row-reverse">
                  ...
                  <div className="p-4 rounded-2xl text-sm leading-sm leading-relaxed shadow-sm bg-zinc-800 text-zinc-200 rounded-tr-sm">
                    I need some information about supportly stack
                  </div>
                </div>
              </div>
              ...
              <div className="flex w-full items-start">
                <div className="flex max-w-[85%] gap-3 flex-row">
                  ...
                  <div className="space-y-2">
                    <div className="p-4 rounded-2xl text-sm leading-relaxed shadow-sm bg-white text-zinc-900 rounded-tl-sm">
                      Supportly Stack is an integrated ecosystem designed to
                      enhance developer efficiency. It includes tools like
                      Supporly Logs for real-time monitoring and Becomedy for
                      community support.
                    </div>
                  </div>
                </div>
